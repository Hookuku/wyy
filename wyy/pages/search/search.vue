				...
				<block v-if="searchType == 1 ">
					<view class="search-history">
						...
						<view class="search-history-list">
							<view  v-for="(item,index) in searchHistory" :key="index"@tap="handleToWord(item),getSearchList(item)" >{{item}}</view>
						</view>
					</view>
					...
					<view class="search-hot">
						...
						<view class="search-hot-item" v-for="(item,index) in searchHot" :key="index" @tap="handleToWord(item.searchWord),handleToSearch(item.searchWord)">
...
<style>
	...
	.search-history-head{ margin-bottom: 36rpx;display: flex;justify-content: space-between;}
