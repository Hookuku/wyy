<template>
	<view class="detail" v-if="songDetail">
...
.detail-play text{ height: 100rpx; width: 100rpx; font-size: 100rpx;color: white;position: absolute;left: 0; right: 0; top: 0;bottom: 0;margin: auto;}
.detail-play view{width: 230rpx;height: 360rpx;background:url(../../static/needle.png);position: absolute;left: 200rpx;right: 0;margin: 0;background-size:cover;top: -220rpx;}
...
.detail-lyric-item{height: 82rpx; overflow: hidden;}
...
.detail-like-song view:nth-child(1){margin-bottom: 12rpx;font-size: 28rpx;color: white;}
...
.detail-comment-text{ border-bottom: 1px solid #e0e0e0; padding-bottom: 40rpx;  margin-top: 20rpx; line-height: 40rpx;font-size: 28rpx;color: white;}
</style>