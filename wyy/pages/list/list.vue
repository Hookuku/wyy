...
<script>
	...
	export default {
		...
		onLoad(options) {
			...
			list(options.id).then((res)=>{console.log(res);
...
<style scoped>
	...
	.list-head-img text{position: absolute;color: white;font-size: 26rpx;top: 8rpx;right: 8rpx;}
	.list-head-text{flex: 1; color: #f0f2f7;}
	.list-head-text view:nth-child(1){font-size: 34rpx;color: white;}
	.list-head-text view:nth-child(2){align-items: center; display: flex;margin: 20rpx 0;font-size: 24rpx;}
	.list-head-text view:nth-child(2) image{ margin-right: 14rpx; width: 54rpx;height: 54rpx;border-radius: 50%;}
	.list-head-text view:nth-child(3){line-height: 34rpx;font-size: 22rpx;}
	
	.list-share{width: 330rpx;height: 74rpx; margin: 0 auto;border-radius: 37rpx;color: white; background: rgba(0,0,0,0.4);text-align: center;line-height: 74rpx;font-size: 28rpx;}
